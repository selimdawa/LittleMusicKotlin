...
import com.flatcode.littlemusic.Filterimport.SongFilter
...
class SongAdapter(
    private val context: Context?, var list: ArrayList<Song?>, listener: (Song?, Int) -> Unit
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (selectedPosition == position) open(holder.wave)
        else holder.wave.visibility = View.GONE
    }
    ...
    /*interface RecyclerItemClickListener {
        fun onClickListener(songs: Song?, postion: Int)
    }*/
