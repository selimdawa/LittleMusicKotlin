    ...
    private fun setupSwitchBars() {
        ...
        binding.switchBarAlbums.apply {
            ...
            mostInterested.setOnClickListener {
                viewModel.setType(
                    DATA.INTERESTED_COUNT, categoryId!!, true
                )
            }
        ...
        binding.switchBarSongs.apply {
            ...
            mostViews.setOnClickListener {
                viewModel.setType(
                    DATA.VIEWS_COUNT, categoryId!!, false
                )
            }
            mostLoves.setOnClickListener {
                viewModel.setType(
                    DATA.LOVES_COUNT, categoryId!!, false
                )
            }
