    ...
    private fun update() {
        ...
        reference.child(albumId!!).updateChildren(hashMap).addOnSuccessListener {
            ...
            if (selectedCategoryId != category) {
                VOID.incrementItemCount(DATAv.CATEGORIES, selectedCategoryId, DATAv.ALBUMS_COUNT)
            ...
            if (selectedArtistId != artist) {
                VOID.incrementItemCount(DATAv.ARTISTS, selectedArtistId, DATAv.ALBUMS_COUNT)
