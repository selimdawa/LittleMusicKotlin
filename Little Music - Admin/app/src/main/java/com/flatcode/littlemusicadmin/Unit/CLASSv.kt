...
object CLASSv {
    ...
    var SONG_ADD: Class<*> = SongAddActivity::class.java
    var SONG_EDIT: Class<*> = SongEditActivity::class.java
    var SONGS: Class<*> = SongsActivity::class.java
    ...
    var ALBUM_ADD: Class<*> = AlbumAddActivity::class.java
    var ALBUM_EDIT: Class<*> = AlbumEditActivity::class.java
    var ALBUMS: Class<*> = AlbumsActivity::class.java
    var ALBUM_SONGS: Class<*> = AlbumSongsActivity::class.java
    var ARTIST_ADD: Class<*> = ArtistAddActivity::class.java
    var ARTIST_EDIT: Class<*> = ArtistEditActivity::class.java
